...
$categories = $categoriesQuery->fetchAll(PDO::FETCH_ASSOC);
  ...
  $id = $_GET["edit"];
  $stmt = $pdo->prepare("SELECT * FROM sub_catagory WHERE id = :id");
  ...
  if (isset($_POST['submit'])) {
    ...
    $stmt = $pdo->prepare("UPDATE sub_catagory SET name = :name, image = :image,
                         catagory_id= :catagory_id WHERE id = :id");
        ...
        <div class="container-fluid">
          ...
          <section class="content" style="margin: 15px;">
            <form method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label for="inputStatus">Category</label>
                          <select  name="catagory_id" id="inputStatus" class="form-control custom-select">
                            ...
                            <?php endforeach; ?>   
                            <option selected><?php echo $catagory['name']; ?></option>
                          </select>
                      </div>  
              ...
              <div class="row">
                <div class="col-12">
                  <a href="../homePage.php?page=sub_catagory" class="btn btn-secondary">Cancel</a>
