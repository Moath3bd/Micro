...
try {
  ...
  $id = $_GET["edit"];
  $stmt = $pdo->prepare("SELECT * FROM catagory WHERE id = :id");
  ...
  if (isset($_POST['submit'])) {
    ...
    $stmt = $pdo->prepare("UPDATE catagory SET name = :name, image = :image
                               WHERE id = :id");
    ...
    if ($stmt->execute()) {
      ...
      header('location: ../homePage.php?page=catagory');
    } else {
        ...
        <div class="container-fluid">
          ...
          <section class="content" style="margin: 15px;">
            <form method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-12">
                  <a href="../homePage.php?page=catagory" class="btn btn-secondary">Cancel</a>
