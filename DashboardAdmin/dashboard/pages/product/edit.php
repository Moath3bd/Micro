...
$sub_categoriesQuery = $pdo->query("SELECT id, name FROM sub_catagory");
$Subcategories = $sub_categoriesQuery->fetchAll(PDO::FETCH_ASSOC);
  ...
  if (isset($_POST['submit'])) {
    ...
    $stmt = $pdo->prepare("UPDATE products SET name = :name, image = :image,
                         price=:price,description= :description,
                         quantity=:quantity,discount= :discount,
                         subid= :subid WHERE id = :id");
    ...
    $stmt->bindParam(':subid', $subid, PDO::PARAM_STR);
        ...
        <div class="container-fluid">
          ...
          <section class="content" style="margin: 15px;">
            <form method="POST" enctype="multipart/form-data">
                  ...
                  <div class="card card-primary">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="inputName" name="name" value="<?php echo $data['name']; ?>" class="form-control">
                      </div>

                      <div class="form-group">
                        <label for="inputName">Price</label>
                        <input type="number" id="inputName" name="price" value="<?php echo $data['price']; ?>" class="form-control">
                      </div>

                      <div class="form-group">
                        <label for="inputDescription">Description</label>
                        <textarea id="inputDescription" name="description" value="<?php echo $data['description']; ?>" class="form-control" rows="4"></textarea>
                      </div>

                      <div class="form-group">
                        <label for="inputName">Quantity</label>
                        <input type="number" id="inputName" name="quantity" value="<?php echo $data['quantity']; ?>" class="form-control">
                      </div>

                      <div class="form-group">
                        <label for="inputName">Discount</label>
                        <input type="number" id="inputName" name="discount" value="<?php echo $data['discount']; ?>" class="form-control">
                      </div>

                      <div class="form-group">
                        <label for="inputStatus">Sub Category</label>
                          <select  name="subid" id="inputStatus" class="form-control custom-select">
                      ...
                      <div class="form-group">
                        <label for="inputName">Current Image</label>
                        <input type="file" name="image" id="image" accept="image/*" required value="<?php echo "images/" . $row['image']; ?>">
                      </div>
              ...
              <div class="row">
                <div class="col-12">
                  <a href="../homePage.php?page=product" class="btn btn-secondary">Cancel</a>
