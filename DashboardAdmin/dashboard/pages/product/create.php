...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
  try {
    ...
    $stmt = $pdo->prepare("INSERT INTO products (name, image,price,quantity,description,
                         discount, subid) VALUES (:name, :image,:quantity, 
                         :price,:description,:discount,:subid)");
                  ...
                  <div class="card card-primary">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" id="inputName" name="price"  class="form-control">
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" id="inputName" name="quantity" class="form-control">
                      </div>

                      <div class="form-group">
                        <label for="inputName">Discount</label>
                        <input type="number" id="inputName" name="discount" class="form-control">
                      </div>
