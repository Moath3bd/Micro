...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
  try {
    ...
    if (!in_array($logoType, $allowedFileTypes)) {
    ...
    $logoPath = "../../uploads/images/" . $uniqueFilename;
    ...
    $stmt = $pdo->prepare("INSERT INTO homeuser (image, logo) 
                          VALUES (:image, :logo)");
    ...
    if ($stmt->execute()) {
      ...
      header('location:../homePage.php?page=homeUser');
    } else {
        ...
        <div class="container-fluid">
          ...
          <section class="content" style="margin: 15px;">
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                  <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">Create Home Page</h3>
              ...
              <div class="row">
                <div class="col-12">
                  <a href="../homePage.php?page=homeUser" class="btn btn-secondary">Cancel</a>
