...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
  try {
    ...
    $stmt = $pdo->prepare("SELECT * FROM ourservices WHERE serviceTitle = :serviceTitle");
    ...
    $stmt = $pdo->prepare("INSERT INTO ourservices (serviceTitle, description) VALUES (:serviceTitle, :description)");
    $stmt->bindParam(':serviceTitle', $serviceTitle, PDO::PARAM_STR);
                ...
                <div class="col-md-12">
                  <div class="card card-primary">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="inputName" name="serviceTitle"  class="form-control">
                      </div>
