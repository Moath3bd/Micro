...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <form method="POST">
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" id="inputName" name="email" value="<?php echo $data['email']; ?>" class="form-control" >
              </div>

              <div class="form-group">
                <label for="inputName">Password</label>
                <input type="text" id="inputName" name="password" value="<?php echo $data['password']; ?>" class="form-control" >
              </div>
              
              
              <div class="form-group">
                <label for="inputClientCompany">Age</label>
                <input type="number" id="inputClientCompany" name="age" value="<?php echo $data['age']; ?>" class="form-control" >
              </div>
              <div class="form-group">
                <label for="inputProjectLeader">Phone</label>
                <input type="text" id="inputProjectLeader" name="phone" value="<?php echo $data['phone']; ?>" class="form-control" >
              </div>
            </div>
            <!-- /.card-body -->
          </div>
      ...
      <div class="row">
        <div class="col-12">
          <a href="../homePage.php?page=user" class="btn btn-secondary">Cancel</a>
